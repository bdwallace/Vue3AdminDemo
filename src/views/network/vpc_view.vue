      ...
      <div class="search-bock">
        <el-form :inline="true" :model="params" class="demo-form-inline">
          ...
          <el-tooltip class="item" effect="dark" content="此操作需要审批" placement="top">
            <el-form-item>
              <el-button type="primary" @click="addDialogVisable=true" :icon="Plus">{{ 'buttons.pureCreateVpc' }}</el-button>
            </el-form-item>
          </el-tooltip>
        ...
        <el-table :data="tableData" border tooltip-effect="dark" @selection-change="handleSelectionChange"
          ...
          <el-table-column
            ...
            <template #default="{ row }">
              ...
              <div v-else-if="col.prop === 'CidrBlockAssociationSet'">
                <el-tag
...
import {getVpcData} from "@/api/vpc_routes";
...
async function fetchData() {
  loading.value = true
  var resp = await getVpcData(params).catch(() => {
    ElMessage({type: 'error', message: '请求响应错误，请联系管理员'})
    return 0
  })
  if (resp.code === 200) {
